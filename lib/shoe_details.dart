...
class _ShoeDetailsPageState extends State<ShoeDetailsPage> {
  ...
  bool isReadMore = false; // State variable to toggle read more/less
              ...
              children: [
                Text(
                  isReadMore
                      ...
                      : 'This shoe is designed for maximum comfort and durability. It features a lightweight design, breathable material, and a stylish look perfect for any occasion.'.substring(0, 100) + '...', // Truncated text
                  style: TextStyle(
                    fontSize: 14,
                ...
                GestureDetector(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 12,
                      fontWeight: FontWeight.bold,
                      color: Colors.black, // Highlight the "Read More" text
                    ),
                  ),
                ),
              ],
